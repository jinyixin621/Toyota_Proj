...
if ispc % Windows
 ...
 CUDA_INC_Location = ['"' getenv('CUDA_PATH')  '\include"'];
    ...
    CUDA_INC_Location = '/usr/cac/rhel6/cuda/6.5/include';
    CUDA_SAMPLES_Location = '/usr/cac/rhel6/cuda/6.5/samples/common/inc';
    Host_Compiler_Location = ' ';
    PIC_Option = ' --compiler-options -fPIC ';
    machine_str = [];
    CUDA_LIB_Location = '/usr/cac/rhel6/cuda/6.5/lib64';
    NVCC = '/usr/cac/rhel6/cuda/6.5/bin/nvcc';
end
